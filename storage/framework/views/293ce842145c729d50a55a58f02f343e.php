...
<div class="detail-container">
    <div class="detail-header">
        ...
        <p class="detail-subtitle"><?php echo e($produit->nom); ?></p>
    </div>
    ...
    <div class="detail-body">
        <div class="detail-grid">
            <div class="detail-item">
                ...
                <div class="price-value"><?php echo e(number_format($produit->prix_achat,2)); ?> DH</div>
            </div>
            <div class="detail-item">
                <div class="detail-label">Prix de vente</div>
                <div class="price-value"><?php echo e(number_format($produit->prix_vente,2)); ?> DH</div>
            </div>
            <div class="detail-item">
                <div class="detail-label">Prix de gros</div>
                <div class="price-value"><?php echo e($produit->prix_gros ? number_format($produit->prix_gros,2).' DH' : '-'); ?></div>
            </div>
            <div class="detail-item">
                <div class="detail-label">Quantité en stock</div>
                <div class="detail-value">
                    <?php if($produit->quantite>0): ?>
                        <span class="badge bg-success"><?php echo e($produit->quantite); ?></span>
                    <?php else: ?>
            ...
            <div class="detail-item">
                ...
                <div class="detail-value"><?php echo e($produit->categorie ? $produit->categorie->nom : 'Non renseignée'); ?></div>
            </div>
            <div class="detail-item">
                <div class="detail-label">Fournisseur</div>
                <div class="detail-value"><?php echo e($produit->fournisseur ? $produit->fournisseur->nom : 'Non renseigné'); ?></div>
            </div>
            <div class="detail-item">
                <div class="detail-label">Date d'achat</div>
                <div class="detail-value"><?php echo e($produit->date_achat ? $produit->date_achat->format('d/m/Y H:i') : 'Non renseignée'); ?></div>
            </div>
        </div>
        ...
        <?php if($produit->description): ?>
            <div class="detail-item" style="margin-bottom:2rem;">
                ...
                <div class="detail-value"><?php echo e($produit->description); ?></div>
            </div>
        <?php endif; ?>

        <?php if($produit->image): ?>
            <div class="text-center">
                <img src="<?php echo e(Str::startsWith($produit->image,'http') ? $produit->image : asset('storage/'.$produit->image)); ?>"
        ...
        <div class="barcode-section">
            ...
            <div class="d-flex justify-content-center gap-2 flex-wrap">
                <a href="<?php echo e(route('produits.barcode', $produit->id)); ?>" class="btn btn-info">
                    <i class="fas fa-barcode"></i> Voir Code Barre
                </a>
                <a href="<?php echo e(route('produits.ticket', $produit->id)); ?>" class="btn btn-success" target="_blank">
                    <i class="fas fa-tag"></i> Imprimer Ticket
                </a>
                <a href="<?php echo e(route('produits.ticket', $produit->id)); ?>?quantity=5" class="btn btn-warning" target="_blank">
                    <i class="fas fa-tags"></i> Tickets x5
                </a>
                <?php if($produit->type==='achat'): ?>
                <a href="<?php echo e(route('produits.facture-achat', $produit->id)); ?>" class="btn btn-primary" target="_blank">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\marwan\clinique\resources\views/produits/show.blade.php ENDPATH**/ ?>