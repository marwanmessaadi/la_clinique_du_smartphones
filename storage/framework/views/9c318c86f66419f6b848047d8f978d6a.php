...
<?php $__env->startSection('title', 'Produits de Vente'); ?>
    ...
    <div class="filter-section mb-4">
        <form method="GET" class="row g-3">
            ...
            <div class="col-md-3">
                ...
                <a href="<?php echo e(route('produits.vente')); ?>" class="btn btn-secondary">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $produits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="price-column"><?php echo e(number_format($produit->prix_vente, 2)); ?> €</td>
                                <td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\marwan\clinique\resources\views/produits/index_vente.blade.php ENDPATH**/ ?>