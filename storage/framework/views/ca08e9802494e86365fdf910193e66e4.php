...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <div class="d-flex align-items-center">
        ...
        <span class="mr-3 text-gray-600">
            ...
            <?php echo e(Auth::user()->prenom ?? 'Utilisateur'); ?> <?php echo e(Auth::user()->nom ?? ''); ?>

            <small class="text-muted">(<?php echo e(ucfirst(Auth::user()->role ?? 'N/A')); ?>)</small>
        </span>
        <span class="mr-3 text-gray-600">
...
</style><?php /**PATH C:\Users\marwan\clinique\resources\views/partials/topbar.blade.php ENDPATH**/ ?>