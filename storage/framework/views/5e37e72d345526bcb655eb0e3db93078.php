...
<?php $__env->startSection('title', 'Facture d\'Achat - ' . $produit->nom); ?>
...
<div class="no-print">
    ...
    <a href="<?php echo e(route('produits.show', $produit)); ?>" class="print-btn" style="background: linear-gradient(45deg, #6c757d, #495057);">
...
<div class="facture-container">
    ...
    <div style="text-align: center; padding: 15px; background: #fff; border-bottom: 1px solid #ddd;">
        ...
        <div style="font-size: 14px; color: #666;">N° PROD-<?php echo e($produit->id); ?>-<?php echo e(date('Y')); ?></div>
    </div>
    ...
    <div class="facture-details">
        <div class="detail-row">
            ...
            <span class="detail-value"><?php echo e($produit->date_achat ? $produit->date_achat->format('d/m/Y à H:i') : 'Non spécifiée'); ?></span>
        </div>

        <div class="detail-row">
            <span class="detail-label">Code produit:</span>
            <span class="detail-value"><?php echo e($produit->code ?? 'Non généré'); ?></span>
        </div>

        <div class="detail-row">
            <span class="detail-label">Catégorie:</span>
            <span class="detail-value"><?php echo e($produit->categorie ? $produit->categorie->nom : 'Non catégorisée'); ?></span>
        </div>

        <div class="detail-row">
            <span class="detail-label">Quantité achetée:</span>
            <span class="detail-value"><?php echo e($produit->quantite); ?> unité(s)</span>
        </div>

        <?php if($produit->notes): ?>
        <div class="detail-row">
            <span class="detail-label">Notes:</span>
            <span class="detail-value"><?php echo e($produit->notes); ?></span>
        </div>
        <?php endif; ?>
    </div>
    ...
    <div class="supplier-info">
        ...
        <div class="detail-row">
            ...
            <span class="detail-value"><?php echo e($produit->fournisseur->nom); ?></span>
        </div>
        <?php if($produit->fournisseur->contact): ?>
        <div class="detail-row">
            <span class="detail-label">Contact:</span>
            <span class="detail-value"><?php echo e($produit->fournisseur->contact); ?></span>
        </div>
        <?php endif; ?>
        <?php if($produit->fournisseur->telephone): ?>
        <div class="detail-row">
            <span class="detail-label">Téléphone:</span>
            <span class="detail-value"><?php echo e($produit->fournisseur->telephone); ?></span>
        </div>
        <?php endif; ?>
        <?php if($produit->fournisseur->email): ?>
        <div class="detail-row">
            <span class="detail-label">Email:</span>
            <span class="detail-value"><?php echo e($produit->fournisseur->email); ?></span>
        </div>
        <?php endif; ?>
    </div>
    <?php endif; ?>
            ...
            <tbody>
                <tr>
                    <td>
                        ...
                        <br><small style="color: #666;"><?php echo e(Str::limit($produit->description, 80)); ?></small>
                        <?php endif; ?>
                        <?php if($produit->code): ?>
                        <br><small style="color: #666;">Code interne: <?php echo e($produit->code); ?></small>
                        <?php endif; ?>
                    </td>
                    <td style="text-align: center;"><?php echo e($produit->quantite); ?></td>
                    <td style="text-align: right;"><?php echo e(number_format($produit->prix_achat, 2)); ?> €</td>
                    <td style="text-align: right;"><?php echo e(number_format($produit->prix_achat * $produit->quantite, 2)); ?> €</td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="total-section">
        <div class="total-row">
            ...
            <span><?php echo e(number_format($produit->prix_achat * $produit->quantite, 2)); ?> €</span>
        </div>
    </div>
    ...
    <div class="barcode-section">
        ...
        <div style="margin-top: 8px; font-size: 11px; color: #666;"><?php echo e($produit->code); ?></div>
    </div>
    ...
    <div class="facture-footer">
        ...
        <div class="footer-text" style="margin-top: 10px; font-size: 10px; color: #999;">
            Facture générée le <?php echo e(now()->format('d/m/Y à H:i')); ?> - Système de Gestion Interne
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\marwan\clinique\resources\views/produits/facture-achat.blade.php ENDPATH**/ ?>