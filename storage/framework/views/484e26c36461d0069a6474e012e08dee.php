...
<div class="dashboard-container">
    <div class="form-card">
        <div class="form-header">
            <h1 class="form-title">Nouveau Client</h1>
            <p class="form-subtitle">Ajouter un nouveau client à votre base de données</p>
        </div>
        ...
        <div class="form-body">
            ...
            <form action="<?php echo e(route('clients.store')); ?>" method="POST">
                ...
                <div class="text-center mt-4">
                    ...
                    <a href="<?php echo e(route('clients.index')); ?>" class="btn btn-cancel">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\marwan\clinique\resources\views/clients/create.blade.php ENDPATH**/ ?>