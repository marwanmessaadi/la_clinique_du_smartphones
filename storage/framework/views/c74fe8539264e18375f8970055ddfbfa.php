...
<?php $__env->startSection('title', 'Point de Vente (Vente)'); ?>
<?php $__env->startSection('content'); ?>
<div class="container py-4" style="min-height:70vh;">
    <div class="d-flex justify-content-center mb-4 gap-3">
        <a href="<?php echo e(route('pos.vente')); ?>" class="btn btn-primary active">Vente Produits</a>
        <a href="<?php echo e(route('pos.reparation')); ?>" class="btn btn-outline-primary">Réparations</a>
    </div>
