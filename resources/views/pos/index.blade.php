            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-info text-white">
                        ...
                        <a href="{{ route('pos.index', array_filter(['search_reparation'=>request('search_reparation')])) }}" class="btn-close" aria-label="Fermer"></a>
                    </div>
                    <div class="modal-body">
                        <ul class="list-group">
                            <li class="list-group-item"><strong>Client :</strong> {{ $details->nom }}</li>
                            <li class="list-group-item"><strong>Description :</strong> {{ $details->description }}</li>
                            <li class="list-group-item"><strong>Produit :</strong> {{ $details->produit }}</li>
                            <li class="list-group-item"><strong>Prix :</strong> {{ number_format($details->prix,2) }} DH</li>
                            <li class="list-group-item"><strong>Date :</strong> {{ $details->date_reparation ? $details->date_reparation->format('d/m/Y H:i') : 'N/A' }}</li>
                            <li class="list-group-item"><strong>État :</strong> {{ ucfirst(str_replace('_',' ',$details->etat)) }}</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-bordered table-hover mb-0" id="table-reparations">
                        ...
                        <tbody>
                            @foreach($reparations as $reparation)
                                <tr class="reparation-row" data-client="{{ strtolower($reparation->nom) }}" data-description="{{ strtolower($reparation->description) }}" data-produit="{{ strtolower($reparation->produit) }}">
                                    <td>{{ $reparation->nom }}</td>
                                    <td>{{ $reparation->description }}</td>
                                    <td>{{ $reparation->produit }}</td>
                                    <td>{{ number_format($reparation->prix, 2) }} DH</td>
        ...
        <div class="modal fade" id="modal-add-reparation" tabindex="-1" aria-labelledby="modalAddReparationLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ route('pos.storeRepair') }}" id="form-add-reparation">
                        @csrf
                        <div class="modal-body">
                            <div class="mb-3">
