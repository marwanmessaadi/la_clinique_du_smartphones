@extends('layouts.app')
@section('title', 'Modifier le Client - ' . $utilisateur->prenom . ' ' . $utilisateur->nom)
            ...
            <div class="form-card">
                ...
                <div class="form-body">
                    ...
                    <div class="client-info">
                        <div class="client-name">{{ $utilisateur->prenom }} {{ $utilisateur->nom }}</div>
                        <div class="client-details">
                            <p><strong>Email:</strong> {{ $utilisateur->email }}</p>
                            <p><strong>Téléphone:</strong> {{ $utilisateur->telephone }}</p>
                            <p><strong>Rôle:</strong> {{ ucfirst($utilisateur->role) }}</p>
                            <p><strong>Inscrit le:</strong> {{ $utilisateur->created_at->format('d/m/Y') }}</p>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('clients.update', $utilisateur) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="text-center mt-4">
                            ...
                            <a href="{{ route('clients.show', $utilisateur) }}" class="btn btn-cancel">
