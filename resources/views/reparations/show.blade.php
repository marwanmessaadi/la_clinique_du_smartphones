...
<div class="detail-container">
    <div class="detail-header">
        ...
        <p class="detail-subtitle">{{ $reparation->nom }}</p>
    </div>
    ...
    <div class="detail-body">
        ...
        <div class="detail-grid">
            <div class="detail-item">
                ...
                <div class="detail-value">{{ $reparation->nom }}</div>
            </div>

            <div class="detail-item">
                <div class="detail-label">Produit</div>
                <div class="detail-value">{{ $reparation->produit }}</div>
            </div>

            <div class="detail-item">
                <div class="detail-label">Prix</div>
                <div class="price-highlight">{{ number_format($reparation->prix, 2) }} €</div>
            </div>

            <div class="detail-item">
                <div class="detail-label">Date de Réparation</div>
                <div class="detail-value">{{ $reparation->date_reparation ? $reparation->date_reparation->format('d/m/Y H:i') : 'Non définie' }}</div>
            </div>
            ...
            <div class="detail-item">
                ...
                <div class="detail-value">{{ $reparation->code ?? 'Non généré' }}</div>
            </div>
        </div>
        ...
        @if($reparation->description)
            <div class="detail-item">
                ...
                <div class="detail-value">{{ $reparation->description }}</div>
            </div>
        @endif
        ...
        <div class="barcode-section">
            ...
            @if($reparation->code)
                <a href="{{ route('reparation.barcode', $reparation) }}" class="btn btn-primary">
        ...
        <div class="action-buttons">
            <a href="{{ route('reparation.edit', $reparation) }}" class="btn btn-warning">
                <i class="fas fa-edit"></i> Modifier
            </a>
            <form action="{{ route('reparation.destroy', $reparation) }}" method="POST" style="display: inline;">
                @csrf
                @method('DELETE')
