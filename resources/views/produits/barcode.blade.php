@extends('layouts.app')
@section('title', 'Code Barre - ' . $produit->code)
...
<div class="barcode-container">
    ...
    <div class="barcode-body">
        <div class="barcode-info">
            ...
            <div class="barcode-value">{{ $produit->nom }}</div>
        </div>

        <div class="barcode-info">
            <div class="barcode-label">Code Produit</div>
            <div class="barcode-value">{{ $produit->code }}</div>
        </div>
        ...
        <div>
            <a href="{{ route('produits.ticket', $produit) }}" class="print-btn" target="_blank">
                🖨️ Imprimer Ticket
            </a>
            <a href="{{ route('produits.show', $produit) }}" class="back-btn">
                ← Retour au Produit
            </a>
        </div>
    </div>
