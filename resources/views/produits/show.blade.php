    ...
    <div class="detail-body">
        ...
        <div class="detail-grid">
            ...
            <div class="detail-item">
                ...
                <div class="detail-value">
                    {{ $produit->date_achat ? $produit->date_achat->format('d/m/Y H:i') : 'Non renseignée' }}
                </div>
            </div>
        </div>
        ...
        <div class="barcode-section">
            ...
            <div class="d-flex justify-content-center gap-2 flex-wrap">
                <a href="{{ route('produits.barcode', $produit) }}" class="btn btn-info">
                    <i class="fas fa-barcode"></i> Voir Code Barre
                </a>
                <a href="{{ route('produits.ticket', $produit) }}" class="btn btn-success" target="_blank">
                    <i class="fas fa-tag"></i> Imprimer Ticket
                </a>
                <a href="{{ route('produits.ticket', $produit) }}?quantity=5" class="btn btn-warning" target="_blank">
                    <i class="fas fa-tags"></i> Tickets x5
                </a>
                @if($produit->type === 'achat')
                <a href="{{ route('produits.facture-achat', $produit) }}" class="btn btn-primary" target="_blank">
